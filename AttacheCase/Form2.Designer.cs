namespace AttacheCase
{
  partial class Form2
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.panelAcademicLicense = new System.Windows.Forms.Panel();
      this.labelAcademicUseLicense = new System.Windows.Forms.Label();
      this.pictureBox2 = new System.Windows.Forms.PictureBox();
      this.contextMenuStrip1 = new System.Windows.Forms.ContextMenuStrip(this.components);
      this.ToolStripMenuItemDeleteLicense = new System.Windows.Forms.ToolStripMenuItem();
      this.buttonDeclareStudentOrEducator = new System.Windows.Forms.Button();
      ...
      this.pictureBoxGitHubIcon = new System.Windows.Forms.PictureBox();
      ...
      this.panelAcademicLicense.SuspendLayout();
      ...
      ((System.ComponentModel.ISupportInitialize)(this.pictureBoxGitHubIcon)).BeginInit();
      ...
      // panelVersion
      // 
      this.panelVersion.Controls.Add(this.panelAcademicLicense);
      this.panelVersion.Controls.Add(this.buttonDeclareStudentOrEducator);
      ...
      this.panelVersion.Controls.Add(this.linkLabelGitHub);
      this.panelVersion.Controls.Add(this.pictureBoxGitHubIcon);
      this.panelVersion.Controls.Add(this.pictureBoxHomeIcon);
      this.panelVersion.Controls.Add(this.linkLabelHomePage);
      ...
      // 
      // panelAcademicLicense
      // 
      this.panelAcademicLicense.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
      this.panelAcademicLicense.Controls.Add(this.labelAcademicUseLicense);
      this.panelAcademicLicense.Controls.Add(this.pictureBox2);
      resources.ApplyResources(this.panelAcademicLicense, "panelAcademicLicense");
      this.panelAcademicLicense.Name = "panelAcademicLicense";
      // 
      // labelAcademicUseLicense
      // 
      resources.ApplyResources(this.labelAcademicUseLicense, "labelAcademicUseLicense");
      this.labelAcademicUseLicense.BackColor = System.Drawing.Color.Transparent;
      this.labelAcademicUseLicense.ForeColor = System.Drawing.Color.DarkGreen;
      this.labelAcademicUseLicense.Name = "labelAcademicUseLicense";
      // 
      // pictureBox2
      // 
      ...
      // 
      // buttonDeclareStudentOrEducator
      // 
      resources.ApplyResources(this.buttonDeclareStudentOrEducator, "buttonDeclareStudentOrEducator");
      this.buttonDeclareStudentOrEducator.Name = "buttonDeclareStudentOrEducator";
      this.buttonDeclareStudentOrEducator.UseVisualStyleBackColor = true;
      this.buttonDeclareStudentOrEducator.Click += new System.EventHandler(this.buttonDeclareStudentOrEducator_Click);
      // 
      ...
      this.pictureBoxLicenseIcon.Click += new System.EventHandler(this.pictureBoxLicenseIcon_Click);
      this.pictureBoxLicenseIcon.MouseDown += new System.Windows.Forms.MouseEventHandler(this.pictureBoxLicenseIcon_MouseDown);
      // 
      // labelUserNameTitle
      // 
      ...
      // 
      resources.ApplyResources(this.pictureBoxGitHubIcon, "pictureBoxGitHubIcon");
      this.pictureBoxGitHubIcon.Name = "pictureBoxGitHubIcon";
      this.pictureBoxGitHubIcon.TabStop = false;
      // 
      // pictureBoxHomeIcon
      // 
      resources.ApplyResources(this.pictureBoxHomeIcon, "pictureBoxHomeIcon");
      ...
      this.buttonRegisterLicense.Click += new System.EventHandler(this.buttonRegisterLicense_Click);
      // 
      // tabPage2
      // 
      ...
      this.panelAcademicLicense.ResumeLayout(false);
      this.panelAcademicLicense.PerformLayout();
      ...
      ((System.ComponentModel.ISupportInitialize)(this.pictureBoxGitHubIcon)).EndInit();
    ...
    private System.Windows.Forms.PictureBox pictureBoxGitHubIcon;
    ...
    private System.Windows.Forms.Button buttonDeclareStudentOrEducator;
    private System.Windows.Forms.Panel panelAcademicLicense;
    private System.Windows.Forms.PictureBox pictureBox2;
    private System.Windows.Forms.Label labelAcademicUseLicense;
  }
}